...
export class TFNorm extends TFOperator {
	...
	UIStructure(node: LGraphNode) {
		...
		node.addWidget("text","ord?","", (value) =>{ this.changeWidgetValue(value,"ord");});
		node.addWidget("text","axis?","", (value) =>{ this.changeWidgetValue(value,"axis");});
		node.addWidget("text","keepDims?","", (value) =>{ this.changeWidgetValue(value,"keepDims");});
