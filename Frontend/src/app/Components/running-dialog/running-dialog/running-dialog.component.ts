...
export class RunningDialogComponent implements OnInit {
  ...
  constructor(private store : Store, public dialogRef: MatDialogRef<RunningDialogComponent>,@Inject(MAT_DIALOG_DATA) public nodeData: NodeData, public dialog : MatDialog) { }
